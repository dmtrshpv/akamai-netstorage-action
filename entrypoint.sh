...
echo "wassup"
scp -i /root/.ssh/privatekey -o 'HostKeyAlgorithms=+ssh-dss' -o 'StrictHostKeyChecking no' -r /github/workspace/${path}/ sshacs@${domainName}.scp.upload.akamai.com:/${cpCode}/${nspath}/  
